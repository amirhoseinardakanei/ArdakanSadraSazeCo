...
class Cooperate(models.Model):
    ...
    driving_motor = models.CharField(max_length=50, verbose_name="گواهینامه موتور", blank=True, null=True)
    has_special_license = models.CharField(max_length=50, verbose_name="وضعیت داشتن کد ویژه", blank=True, null=True)
    special_license_code = models.TextField(max_length=50, blank=True, null=True, verbose_name="کد گواهینامه ویژه")
    driving_license_image = models.ImageField(upload_to='driving_licenses/', blank=True, null=True, verbose_name="تصویر گواهینامه")
    driving_license_image2 = models.ImageField(upload_to='driving_licenses/', blank=True, null=True, verbose_name="تصویر پشت گواهینامه")
    previous_work_experience = models.CharField(max_length=100, blank=True, null=True, verbose_name="سابقه کار قبلی")
    ...
    relatedـworkـexperience = models.CharField(max_length=30, blank=True, null=True, verbose_name="وضعیت سابقه کار مرتبط با شرکت")
    descriptionـrelatedـwork = models.TextField(blank=True, null=True, verbose_name="سابقه کار مرتبط با شرکت")
